      ...
      <main className="track-record theory-of-change">
        <section className="tr-hero">
          ...
          <div className="container tr-hero-inner">
            ...
            <h1 className="tr-hero-title">Theory of <span className="tr-title-accent">Change</span></h1>
        ...
        <article className="toc-article">
          <div className="container toc-inner">
            <section className="toc-section" id="long-term-goals">
              ...
              <p>The <a href="https://pauseai.info/proposal" className="inline-link" target="_blank" rel="noreferrer">proposal</a> on PauseAI Global&rsquo;s website outlines our primary policy goal. In brief, we propose a global pause treaty regulated by an international AI Safety Agency (AISA) that is responsible for determining when more powerful AI systems can be safely developed. Even after the risk of losing control of AI has been reduced to acceptable levels, any sufficiently large group of countries would be empowered to veto the deployment of a superhuman AI system. This ensures that, if some countries feel that they will be excluded from the benefits of AI, they have a strong negotiating position with which to demand their fair share. Or, if a group of democratic countries believe that an authoritarian country will deploy AI to oppress its own people, they can push for a deployment that empowers all citizens in every country.</p>
              <p>Before safe AI is technically feasible, it is in the interest of all major powers to enforce the treaty globally. Once AI alignment is solved, AISA will control any superhuman AI prior to deployment and be able to use it to enforce the treaty. Of course, such a treaty still ultimately hinges on the trustworthiness of a few people and institutions, but we do not know of any governance strategy that does not have this weakness.</p>
              <p>Such a treaty is possible to enforce due to the <a href="https://pauseai.info/building-the-pause-button" className="inline-link" target="_blank" rel="noreferrer">highly centralised AI chip supply chain</a>. Writing highly detailed policy proposals is not our comparative advantage, so we generally defer to other organisations for <a href="https://techgov.intelligence.org/research/an-international-agreement-to-prevent-the-premature-creation-of-artificial-superintelligence" className="inline-link" target="_blank" rel="noreferrer">draft treaty texts</a> and the precise specifications of enforcement mechanisms.</p>
              <p>As mentioned above, we are in favour of other AI safety regulations, such as <a href="https://ai-frontiers.org/articles/case-for-ai-liability" className="inline-link" target="_blank" rel="noreferrer">stronger liability</a> for developers for AI-enabled harms. We may sometimes explicitly push for such policies both because they increase AI safety directly and they can be instrumental for increasing PauseAI&rsquo;s influence or credibility. For example, our <a href="https://pauseai.info/dear-sir-demis-2025" className="inline-link" target="_blank" rel="noreferrer">open letter</a> signed by 60 UK lawmakers criticised Google DeepMind for <a href="https://pauseai.info/pdfs/PauseAI_Open_Letter_Background_Information.pdf" className="inline-link" target="_blank" rel="noreferrer">violating</a> the <a href="https://www.gov.uk/government/publications/frontier-ai-safety-commitments-ai-seoul-summit-2024/frontier-ai-safety-commitments-ai-seoul-summit-2024" className="inline-link" target="_blank" rel="noreferrer">Frontier AI Safety Commitments</a> and helped to establish our voice in British AI policy.</p>
            </section>
            ...
            <section className="toc-section" id="positive-outcomes">
              ...
              <p>Each MP has 20 PauseAI volunteers in their constituency who will send emails to their office and request meetings in which all 20 constituents will show up to express their views. PauseAI coordinates its network using PauseAI UK&rsquo;s <a href="https://catalyse.up.railway.app/" className="inline-link" target="_blank" rel="noreferrer">Catalyse platform</a> to push the government to introduce an AI bill and ensure that it has the backing of every MP.</p>
              ...
              <p>At some point a significant, but not existential, AI catastrophe thrusts AI risks into the public consciousness and highlights the imminence of superhuman AI. Millions of British citizens become viscerally aware of the looming threat to their lives. PauseAI UK immediately announces a new protest and volunteers spread the sign-up page in their networks.</p>
            ...
            <section className="toc-section" id="local-groups">
              <h2>Local groups</h2>
              <p>When cities hit a critical mass of enthusiastic volunteers, we will launch new local groups in those cities. There are three core activities for local groups to engage in:</p>
              <ol className="toc-list">
                <li>Deliver presentations to explain the urgent risks of AI and what we can do about it. These presentations can be given over and over at different events and adapted to different audiences.</li>
